...
// routes/dashboard/task.$taskId.tsx
...
type Module = typeof import("../task.$taskId.js")

export type Info = {
  parents: [Parent0, Parent1],
  id: "routes/dashboard/task.$taskId"
  file: "routes/dashboard/task.$taskId.tsx"
  path: "dashboard/task/:taskId"
  params: {"taskId": string} & { [key: string]: string | undefined }
  module: Module
